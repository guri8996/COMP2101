...
#in the first half we test if the folder already has file pics.tgz file and if it dont it implies to the next command where it download pics.tgz from https://zonzorp.net/pics.tgz
...
#in the first half we test if the folder already has the file pics.tgz file and then if yes it extract files from the folder using -zxf and copy all the stuff in ~/Pictures/pics.tgz and removing the local copy of tar file.
